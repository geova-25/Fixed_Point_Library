...
proc create_root_design { parentCell } {
  ...
  # Create instance: fixed_point_divider_0, and set properties
  set block_name fixed_point_divider
  set block_cell_name fixed_point_divider_0
  if { [catch {set fixed_point_divider_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $fixed_point_divider_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.Word_length {32} \
   CONFIG.fractional_bits {24} \
 ] $fixed_point_divider_0
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins fixed_point_divider_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins fixed_point_divider_0/rst_n] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
